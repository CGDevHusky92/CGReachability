/*
 ...
 Modified By Chase Gorectke
 Revision Works, LLC 2014
...
{
	CGReachability* returnValue = NULL;
...
+ (instancetype)reachabilityForLocalWiFi
{
	...
	CGReachability* returnValue = [self reachabilityWithAddress: &localWifiAddress];
	if (returnValue != NULL) {
